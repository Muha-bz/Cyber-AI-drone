...
* В топике подписать **`Название всех объектов`**, обозначить их цвет и написать координаты обнаруженных объектов в терминале, и обвести контур всех обнаруженных объектов.
