...
* В топике подписать **`Название всех объектов`**, обозначить их цвет, написать координаты обнаруженных объектов в терминале, и обвести контур всех обнаруженных объектов.
